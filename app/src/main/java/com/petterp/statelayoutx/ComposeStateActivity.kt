...
import com.petterp.statelayoutx.compose.ComposeState
import com.petterp.statelayoutx.compose.ComposeStateControlImpl
import com.petterp.statelayoutx.ui.theme.StateLayoutXTheme
            ...
            StateLayoutXTheme {
                Column {
                    var state by remember {
                        mutableStateOf(
                            ComposeStateControlImpl.init().apply {
                                onEmpty {
